...
/* First created by JCasGen Wed Sep 24 01:20:56 EDT 2014 */
...
/** It is the super class for all the other subclasses that will be added into the system. The two common features of Annotation class is necessary to share among all its subclasses.
